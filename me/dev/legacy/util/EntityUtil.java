...
public class EntityUtil implements Util {
   ...
   public static boolean isCrystalAtFeet(EntityEnderCrystal crystal, double range) {
      ...
      while(true) {
         ...
         } while(Client.friendManager.isFriend(player));
   ...
   public static Map<String, Integer> getTextRadarPlayers() {
      ...
      while(var5.hasNext()) {
         ...
         if (!player.func_82150_aj() && !player.func_70005_c_().equals(mc.field_71439_g.func_70005_c_())) {
            ...
            ((Map)output).put(healthSB.toString() + " " + (Client.friendManager.isFriend(player) ? ChatFormatting.AQUA : ChatFormatting.RED) + player.func_70005_c_() + " " + distanceSB.toString() + " Â§f0", (int)mc.field_71439_g.func_70032_d(player));
