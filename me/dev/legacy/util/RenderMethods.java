...
public class RenderMethods {
   ...
   public static void drawOutlinedBox(AxisAlignedBB paramAxisAlignedBB) {
      if (paramAxisAlignedBB != null) {
         GL11.glBegin(3);
         GL11.glVertex3d(paramAxisAlignedBB.field_72340_a, paramAxisAlignedBB.field_72338_b, paramAxisAlignedBB.field_72339_c);
         GL11.glVertex3d(paramAxisAlignedBB.field_72336_d, paramAxisAlignedBB.field_72338_b, paramAxisAlignedBB.field_72339_c);
         GL11.glVertex3d(paramAxisAlignedBB.field_72336_d, paramAxisAlignedBB.field_72338_b, paramAxisAlignedBB.field_72334_f);
         GL11.glVertex3d(paramAxisAlignedBB.field_72340_a, paramAxisAlignedBB.field_72338_b, paramAxisAlignedBB.field_72334_f);
         GL11.glVertex3d(paramAxisAlignedBB.field_72340_a, paramAxisAlignedBB.field_72338_b, paramAxisAlignedBB.field_72339_c);
         GL11.glEnd();
         GL11.glBegin(3);
         GL11.glVertex3d(paramAxisAlignedBB.field_72340_a, paramAxisAlignedBB.field_72337_e, paramAxisAlignedBB.field_72339_c);
         GL11.glVertex3d(paramAxisAlignedBB.field_72336_d, paramAxisAlignedBB.field_72337_e, paramAxisAlignedBB.field_72339_c);
         GL11.glVertex3d(paramAxisAlignedBB.field_72336_d, paramAxisAlignedBB.field_72337_e, paramAxisAlignedBB.field_72334_f);
         GL11.glVertex3d(paramAxisAlignedBB.field_72340_a, paramAxisAlignedBB.field_72337_e, paramAxisAlignedBB.field_72334_f);
         GL11.glVertex3d(paramAxisAlignedBB.field_72340_a, paramAxisAlignedBB.field_72337_e, paramAxisAlignedBB.field_72339_c);
         GL11.glEnd();
         GL11.glBegin(1);
         GL11.glVertex3d(paramAxisAlignedBB.field_72340_a, paramAxisAlignedBB.field_72338_b, paramAxisAlignedBB.field_72339_c);
   ...
   public static void drawStrip(int paramInt1, int paramInt2, float paramFloat1, double paramDouble, float paramFloat2, float paramFloat3, int paramInt3) {
      float f1 = (float)(paramInt3 >> 24 & 255) / 255.0F;
      float f2 = (float)(paramInt3 >> 16 & 255) / 255.0F;
      float f3 = (float)(paramInt3 >> 8 & 255) / 255.0F;
      float f4 = (float)(paramInt3 & 255) / 255.0F;
      GL11.glPushMatrix();
      GL11.glTranslated((double)paramInt1, (double)paramInt2, 0.0D);
      ...
      if (paramDouble > 0.0D) {
         ...
         for(b = 0; (double)b < paramDouble; ++b) {
            f5 = (float)((double)b * paramDouble * 3.141592653589793D / (double)paramFloat2);
            f6 = (float)(Math.cos((double)f5) * (double)paramFloat3);
            f7 = (float)(Math.sin((double)f5) * (double)paramFloat3);
   ...
   public static void glColor(Color paramColor) {
      GL11.glColor4f((float)paramColor.getRed() / 255.0F, (float)paramColor.getGreen() / 255.0F, (float)paramColor.getBlue() / 255.0F, (float)paramColor.getAlpha() / 255.0F);
   }
   ...
   public static void glColor(int paramInt) {
      float f1 = (float)(paramInt >> 24 & 255) / 255.0F;
      float f2 = (float)(paramInt >> 16 & 255) / 255.0F;
      float f3 = (float)(paramInt >> 8 & 255) / 255.0F;
      float f4 = (float)(paramInt & 255) / 255.0F;
      GL11.glColor4f(f2, f3, f4, f1);
   }
   ...
   public static void rectangle(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, int paramInt) {
      ...
      bufferBuilder.func_181662_b(paramDouble1, paramDouble4, 0.0D);
      bufferBuilder.func_181662_b(paramDouble3, paramDouble4, 0.0D);
      bufferBuilder.func_181662_b(paramDouble3, paramDouble2, 0.0D);
      bufferBuilder.func_181662_b(paramDouble1, paramDouble2, 0.0D);
   ...
   public static void drawFullCircle(int paramInt1, int paramInt2, double paramDouble, int paramInt3) {
      ...
      for(byte b = 0; b <= 360; ++b) {
         double d1 = Math.sin((double)b * 3.141592653589793D / 180.0D) * paramDouble;
         double d2 = Math.cos((double)b * 3.141592653589793D / 180.0D) * paramDouble;
         GL11.glVertex2d((double)paramInt1 + d1, (double)paramInt2 + d2);
      }
   ...
   public static void drawTriangle(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5) {
      ...
      case 3:
         GL11.glBegin(2);
         GL11.glVertex2d((double)paramInt1, (double)paramInt2);
         GL11.glVertex2d((double)paramInt1 + (double)paramInt4 * 1.25D, (double)(paramInt2 - paramInt4 / 2));
         GL11.glVertex2d((double)paramInt1 + (double)paramInt4 * 1.25D, (double)(paramInt2 + paramInt4 / 2));
         GL11.glEnd();
         GL11.glBegin(4);
         GL11.glVertex2d((double)paramInt1 + (double)paramInt4 * 1.25D, (double)(paramInt2 - paramInt4 / 2));
   ...
   public static void drawBorderedRect(Rectangle paramRectangle, float paramFloat, int paramInt1, int paramInt2) {
      float f1 = (float)paramRectangle.x;
      float f2 = (float)paramRectangle.y;
      float f3 = (float)(paramRectangle.x + paramRectangle.width);
      float f4 = (float)(paramRectangle.y + paramRectangle.height);
      enableGL2D();
      glColor(paramInt1);
   ...
   public static void drawCircle(float paramFloat1, float paramFloat2, float paramFloat3, int paramInt1, int paramInt2) {
      ...
      paramFloat1 *= 2.0F;
      paramFloat2 *= 2.0F;
      float f1 = (float)(paramInt2 >> 24 & 255) / 255.0F;
      float f2 = (float)(paramInt2 >> 16 & 255) / 255.0F;
      float f3 = (float)(paramInt2 >> 8 & 255) / 255.0F;
      float f4 = (float)(paramInt2 & 255) / 255.0F;
      float f5 = (float)(6.2831852D / (double)paramInt1);
