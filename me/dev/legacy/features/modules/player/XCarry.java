...
public class XCarry extends Module {
   ...
   public void onUpdate() {
      if ((Boolean)this.shiftClicker.getValue() && mc.field_71462_r instanceof GuiInventory) {
         ...
         Slot slot;
         if ((Keyboard.isKeyDown(42) && (Boolean)this.withShift.getValue() || ourBind) && Mouse.isButtonDown(0) && (slot = ((GuiInventory)mc.field_71462_r).getSlotUnderMouse()) != null && InventoryUtil.getEmptyXCarry() != -1) {
   ...
   public void onKeyInput(KeyInputEvent event) {
      if (Keyboard.getEventKeyState() && !(mc.field_71462_r instanceof OyVeyGui) && ((Bind)this.autoStore.getValue()).getKey() == Keyboard.getEventKey()) {
         this.autoDuelOn = !this.autoDuelOn;
         Command.sendMessage("<XCarry> §aAutostoring...");
      }
